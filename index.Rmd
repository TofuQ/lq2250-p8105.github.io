---
title: "Webisite for P8105 Homework4"
output: 
  html_document:
    toc: true
    toc_float: true
...
To show the flexdashboard I made from [instacart](https://p8105.com/dataset_instacart.html) dataset loaded from `p8105.datasets` package. Check out [this page](plots.html) for details.
